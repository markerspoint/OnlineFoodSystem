...
<section id="review" style="background-color: #2e2d2d; padding: 50px 0;">
    <div class="container" style="max-width: 1200px; margin: 0 auto;">
        <div class="text-center" style="margin-bottom: 30px;">
            ...
            <button type="button" class="btn custom-btn" data-bs-toggle="modal" data-bs-target="#reviewModal">
                    ...
                    <div class="col">
                        <div class="testimonials mt-4" data-id="<?php echo $row['id']; ?>" 
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-2 mb-2">
                                    <h3 style="font-size: 1.2rem; margin: 0; color: #fff;"><?php echo $row['menu_item_name']; ?></h3>
                                    <a href="#" class="text-decoration-none" style="font-size: 0.9rem; color: #ff4d4d;">Rating: <?php echo $row['rating']; ?></a>
                                </div>
                            </div>
                            <p style="margin-top: 10px; font-size: 1rem; color: #fff;"><?php echo $row['comment']; ?></p>
                            <!-- Edit Button -->
                            <button class="btn btn-sm btn-secondary edit-review" data-id="<?php echo $row['id']; ?>" data-bs-toggle="modal" data-bs-target="#reviewModal" style="color: #fff;">Edit</button>
                        </div>
                    </div>
                    <?php
                }
...
<style>
    .custom-btn {
    background-color: #ff4d4d; /* Set the background color */
    border-color: #ff4d4d; /* Match the border color */
    color: #fff; /* Set text color to white for contrast */
    }

    .custom-btn:hover {
    background-color: #e64545; /* Slightly darker shade for hover effect */
    }
